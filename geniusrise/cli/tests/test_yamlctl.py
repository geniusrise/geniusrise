...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "batch", "batch", "postgres"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "batch", "batch", "dynamodb"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "batch", "batch_to_stream", "in_memory"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "batch", "batch_to_stream", "redis"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "batch", "batch_to_stream", "postgres"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "batch", "batch_to_stream", "dynamodb"),
        ...
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "streaming", "batch_to_stream", "in_memory"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "streaming", "batch_to_stream", "redis"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "streaming", "batch_to_stream", "postgres"),
        ("TestSpoutCtlSpout", "TestBoltCtlBolt", "streaming", "batch_to_stream", "dynamodb"),
