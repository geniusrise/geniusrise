...
from geniusrise.data_sources.files.binary import ELFExtractor
from geniusrise.data_sources.files.code import HTMLExtractor, JSONExtractor, MarkdownExtractor, XMLExtractor
from geniusrise.data_sources.files.documents import PDFExtractor, RTFExtractor, TXTExtractor
from geniusrise.data_sources.files.office import DocExtractor, ODTExtractor, PPTExtractor
from geniusrise.data_sources.files.sheets import CSVExtractor, ExcelExtractor, ODSExtractor
