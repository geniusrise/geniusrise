    ...
    def perform_llama_cpp(
        ...
        **kwargs,
        ...
        for i in range(0, len(dataset), n_batch):
            ...
            completions = llama_model.create_chat_completion(
                messages=[{"content": prompt, "role": "user"} for prompt in batch],
                functions=generation_args.get("functions"),
                function_call=generation_args.get("function_call"),
                tools=generation_args.get("tools"),
                tool_choice=generation_args.get("tool_choice"),
                ...
                stream=generation_args.get("stream", False),
                stop=generation_args.get("stop", []),
                seed=generation_args.get("seed"),
                response_format=generation_args.get("response_format"),
                ...
                logits_processor=generation_args.get("logits_processor"),
                grammar=generation_args.get("grammar"),
                logit_bias=generation_args.get("logit_bias"),
                logprobs=generation_args.get("logprobs"),
                top_logprobs=generation_args.get("top_logprobs"),
            )

            self._save_completions(completions["choices"][0]["message"]["content"], batch, output_path)  # type: ignore
        self.done()
