...
class SpoutFactory:
    """
    Factory class for creating spouts of various types.
    """

    @staticmethod
    def create(input_type: str, output_type: str, state_type: str, task_type: str, **kwargs) -> Task:
        """
